  ...
  return (
    <footer className="border-t bg-background/80 backdrop-blur-sm">
      <div className="container py-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <Link to="/" className="flex items-center space-x-2">
              <div className="h-8 w-8 rounded-full bg-gradient-to-br from-purple-500 to-indigo-700"></div>
              <span className="text-xl font-bold">TexGen</span>
            </Link>
            <p className="mt-4 text-sm text-muted-foreground">
              AI-powered texture generation for designers, developers, and 3D artists.
            </p>
          </div>
        ...
        <div className="mt-10 pt-6 border-t flex flex-col md:flex-row md:justify-between items-center">
          <p className="text-sm text-muted-foreground">© {new Date().getFullYear()} TexGen. All rights reserved.</p>
